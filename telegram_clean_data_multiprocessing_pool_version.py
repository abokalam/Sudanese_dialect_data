# you should have files with the header ['Time', 'Text', 'User'] and you should rename all your files to numbers line 1,2,3,4 and so one and put them all at telegram_cleaning_multi_input_file file
# create the file telegram_cleaning_multi_output_file and all your outputs will be there
...
csvfiles = os.listdir('telegram_cleaning_multi_input_file')
...
def launch(csvfile):
    ...
    csv_path = 'telegram_cleaning_multi_input_file/'+csvfile
    ...
    path = "telegram_cleaning_multi_output_file/"+file_name
