...
def launch(the_list):
    ...
    path = "/home/muhammed/Desktop/MTN/chatbot/clean_data_test_after_code/"+file_name
    
    print('new file path is '+path)
    print('.....................................................................')
    new_df.to_csv(path, mode='a')
    #append to csv
...
if __name__ =='__main__':
    ...
    for csvfile in csvfiles:
        csv_path = '/home/muhammed/Desktop/MTN/chatbot/clean_data_test/'+csvfile
        df = pd.read_csv(csv_path)
        len_data = len(df) / num_processes
        
        pool = mp.Pool(num_processes)
        b = [df.iloc[int(len_data*i):int(i*len_data+len_data),:] for i in range(num_processes)]
        
        pool.map(launch, (b[i] for i in range(num_processes)))
